...
* 사용할 기술은 kotlin + springboot + postgresql+ Vanilla + express를 사용한 학습내용을 정리할 예정입니다.
...
* 프론트서버가 백엔드 서버를 참고하기 위한 cors 설정입니다. (view 구현을 vue로)
*    private val localhost = "http://localhost:3000" 부분을 프론트서버 주소를 입력하시면 됩니다.
